...
const sourceContracts = [
  ...
  ['disabled response is 403 MODULE_NOT_ENABLED', routeSource, /MODULE_DISABLED_HTTP_STATUS = 403[\s\S]*error: 'MODULE_NOT_ENABLED'/],
  ['dependency-disabled response is normalized to 403 MODULE_NOT_ENABLED', routeSource, /MODULE_DEPENDENCY_NOT_ENABLED'[\s\S]*MODULE_DISABLED_RESPONSE, MODULE_DISABLED_HTTP_STATUS/],
  ['disabled response uses exact safe message', routeSource, /message: '此工作區尚未啟用此功能模組。'/],
